...
const CreateArticleDemo: React.FC<Props> = observer(() => {
  ...
  React.useEffect(() => {
    setEditor(
      new EditorJS({
        ...
        data: JSON.parse(
          '{"time":1614514401337,"blocks":[{"type":"header","data":{"text":"Ссылка на платформу курса","level":2}},{"type":"header","data":{"text":"Содержание курса","level":2}},{"type":"header","data":{"text":"Что понравилось?","level":2}},{"type":"header","data":{"text":"Что не понравилось?","level":2}},{"type":"header","data":{"text":"Заключение","level":2}}],"version":"2.19.1"}'
        ),
      })
    );
  }, []);
...
export default CreateArticleDemo;
